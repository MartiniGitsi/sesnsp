...
nom_agrupador_selecc = st.selectbox("Selecciona un delito:", dfCabAgrp['Nombre_Agrupador_Delito'])
...
ax.plot ('dt64', 'tasa_nal', data= dftemp, linewidth= AnchoLinea, linestyle= '-.', color='salmon', label='tasa nacional')
...
st.write ("Datos considerados:")
st.table(dftemp[['Aniomes','tasa','tasa_nal']])
#st.write (dftemp[['Aniomes','tasa','tasa_nal']])
